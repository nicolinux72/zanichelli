...
import it.nicolasanti.config.audit.AuditEventConverter;
import it.nicolasanti.domain.PersistentAuditEvent;
...
import static it.nicolasanti.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
