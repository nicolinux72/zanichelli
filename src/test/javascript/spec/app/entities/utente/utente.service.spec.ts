...
describe('Service Tests', () => {
    describe('Utente Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Utente(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Utente', async () => {
            ...
            it('should update a Utente', async () => {
                const returnedFromService = Object.assign(
                    {
                        nome: 'BBBBBB',
                        cognome: 'BBBBBB',
            ...
            it('should return a list of Utente', async () => {
                const returnedFromService = Object.assign(
                    {
                        nome: 'BBBBBB',
                        cognome: 'BBBBBB',
            ...
            it('should delete a Utente', async () => {
